...
const DATA_INFO: [([f32; 2], [f32; 2], [&str; 3]); 10] = [
    // SLR
    ([3.0, 13.0], [5.0, 11.0], ["red", "green", "red"]),
    // TMOS-S
    ([3.0, 4.2], [3.8, 4.0], ["red", "yellow", "green"]),
    // RLR
    ([-7.0, -1.0], [-5.0, -3.0], ["red", "green", "yellow"]),
    // TMOS-RCV
    ([2.8, 4.2], [3.8, 3.4], ["red", "yellow", "green"]),
    // G-MOS
    ([3.6, 4.1], [3.8, 3.95], ["red", "yellow", "green"]),
    // S-MOS
    ([3.6, 4.1], [3.8, 4.0], ["red", "yellow", "green"]),
    // N-MOS
    ([3.8, 4.5], [4.0, 4.2], ["red", "yellow", "green"]),
    // DT_SEND
    ([1.0, 9.0], [3.0, 6.0], ["green", "yellow", "red"]),
    // TCLW
    ([50.0, 80.0], [65.0, 70.0], ["red", "yellow", "green"]),
    // delay
    ([0.0, 222.0], [150.0, 180.0], ["green", "yellow", "red"]),
];
...
fn main() {
    ...
    let mut plot = Plot::new(100.0, 100.0, 90.0, 10);
